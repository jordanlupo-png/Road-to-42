...
(function(){
 ...
 let activities=['level','evolution'].includes(params)?[{id:1,user_id:user.id,activity_date:'2026-09-14',activity_type:'run',distance_km:25,duration_minutes:150,source:'google_health'}]:[{id:1,user_id:user.id,activity_date:'2026-09-14',activity_type:'run',distance_km:7.1,duration_minutes:44,source:'google_health'}];
 ...
 let notifications=params==='notifications'?[{id:3,recipient_id:user.id,actor_id:'friend-1',kind:'badge',title:'Julia earned a badge',body:'Julia unlocked “Weekly goal”.',metadata:{badge:'Weekly goal'},created_at:'2026-09-20T18:05:00Z',read_at:null},{id:2,recipient_id:user.id,actor_id:'friend-1',kind:'xp',title:'Julia gained XP',body:'Julia earned 8.2 XP from a run.',metadata:{xp:8.2},created_at:'2026-09-20T18:00:00Z',read_at:null}]:params==='evolution'?[{id:4,recipient_id:user.id,actor_id:user.id,kind:'level_up',title:'Level 2 reached!',body:'QA Runner’s Lynx reached Level 2.',metadata:{from_level:1,level:2,character:'lynx'},created_at:'2026-09-20T18:10:00Z',read_at:null}]:[];
